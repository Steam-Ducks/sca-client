<template>
  <header class="navbar">
    <div class="nav-logo">
      <svg class="nav-logo-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
      ...
      <span class="nav-logo-text">SCAR</span>
    </div>

    <nav class="nav-tabs">
      <RouterLink class="nav-tab" to="/dashboard">
      ...
      <RouterLink class="nav-tab" to="/materiais">
        <svg class="tab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <RouterLink class="nav-tab" to="/horas">
        <svg class="tab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <RouterLink class="nav-tab" to="/consolidado">
        <svg class="tab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <RouterLink class="nav-tab" to="/orcamento">
        <svg class="tab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <RouterLink class="nav-tab" to="/auditoria">
        <svg class="tab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
    ...
    <div class="nav-right">
      <svg class="nav-user-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" stroke-linecap="round" stroke-linejoin="round"/>
        <circle cx="12" cy="7" r="4"/>
      </svg>
      <div class="nav-user">Administrador</div>
      <button class="nav-icon-btn" type="button" title="Configurações">

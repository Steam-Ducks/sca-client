    ...
    <main class="main">
      ...
      <div class="filters-card">
        ...
        <div class="filters-row" style="margin-top: 10px">
          <div class="search-wrap">
            ...
            <input class="search-input" v-model="filters.search" placeholder="Buscar material..." />
          </div>
      ...
      <div class="charts-row">
        <div class="chart-card">
          ...
          <div class="chart-wrap tall"><canvas id="chartProjeto"></canvas></div>
        </div>
        <div class="chart-card">
      ...
      <div class="table-card">
        ...
        <div class="table-wrap">
          <table>
            <thead>
              <tr>
                <th class="sort-col" @click="sort('material')">Material {{ sortIcon('material') }}</th>
                <th class="sort-col" @click="sort('projeto')">Projeto {{ sortIcon('projeto') }}</th>
                <th class="sort-col" @click="sort('programa')">Programa {{ sortIcon('programa') }}</th>
                <th class="sort-col" @click="sort('quantidade')">Quantidade {{ sortIcon('quantidade') }}</th>
                <th class="sort-col" @click="sort('valorUnitario')">Valor Unitário {{ sortIcon('valorUnitario') }}</th>
                <th class="sort-col" @click="sort('valorTotal')">Valor Total {{ sortIcon('valorTotal') }}</th>
                <th class="sort-col" @click="sort('periodo')">Período {{ sortIcon('periodo') }}</th>
                <th>Fornecedor</th>
                <th>Categoria</th>
              </tr>
            </thead>

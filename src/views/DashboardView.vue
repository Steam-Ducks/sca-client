    ...
    <main class="main">
      ...
      <div class="metrics">
        <div class="metric-card">
          ...
          <div class="metric-value blue">{{ kpisLoading ? '...' : fmt(kpis.total_consolidated_cost) }}</div>
        </div>
        <div class="metric-card">
          <div class="metric-label">Custo Total de Materiais</div>
          <div class="metric-value">{{ kpisLoading ? '...' : fmt(kpis.total_materials_cost) }}</div>
        </div>
        <div class="metric-card">
          <div class="metric-label">Custo Total de Horas Técnicas</div>
          <div class="metric-value green">{{ kpisLoading ? '...' : fmt(kpis.total_hours_cost) }}</div>
        </div>
        <div class="metric-card">
          <div class="metric-label">Número de Projetos</div>
          <div class="metric-value">{{ kpisLoading ? '...' : kpis.total_projects }}</div>
        </div>
        <div class="metric-card">
          <div class="metric-label">Número de Programas</div>
          <div class="metric-value">{{ kpisLoading ? '...' : kpis.total_programs }}</div>
        </div>
      </div>
...
async function fetchTableData() {
  ...
  try {
    ...
    if (!response.ok) throw new Error(`Erro ao buscar tabela: ${response.status}`)

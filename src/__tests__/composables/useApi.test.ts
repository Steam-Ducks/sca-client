...
describe('useApi', () => {
  ...
  describe('fetchUsers', () => {
    it('should fetch users successfully', async () => {
      const mockUsers: User[] = [
        { id: 1, username: 'user1', email: 'user1@example.com', date_joined: '2024-01-01' },
        { id: 2, username: 'user2', email: 'user2@example.com', date_joined: '2024-01-02' },
      ]
    ...
    it('should return empty array on error', async () => {
      ...
      vi.mocked(apiService.user.fetchUsers).mockRejectedValue(new Error('API Error'))
  ...
  describe('createUser', () => {
    ...
    it('should return null on error', async () => {
      ...
      vi.mocked(apiService.user.createUser).mockRejectedValue(new Error('API Error'))
  ...
  describe('healthCheck', () => {
    ...
    it('should return false when health check throws error', async () => {
      const consoleSpy = vi.spyOn(console, 'error').mockImplementation(() => {})
      vi.mocked(apiService.health.check).mockRejectedValue(new Error('Connection failed'))
